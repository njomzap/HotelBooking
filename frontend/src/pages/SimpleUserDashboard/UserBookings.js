...
const UserBookings = () => {
  ...
  if (loading)
    return <div className="text-center mt-10 text-gray-500">Loading your bookings...</div>;
  if (error) return <div className="text-center mt-10 text-red-500">{error}</div>;

  return (
    <div className="max-w-7xl mx-auto mt-24 px-4"> 
      <h2 className="text-4xl font-bold mb-10 text-center text-gray-800">Your Bookings</h2>

      {bookings.length === 0 ? (
        <p className="text-center text-gray-400 italic">You have no bookings yet.</p>
      ) : (
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {bookings.map((b) => {
            ...
            const isPendingPayment = b.status === "payment_pending" || b.status === "pending";
            ...
            return (
              ...
              >
                ...
                <div className="mb-4">
                  <h3 className="text-2xl font-semibold mb-2 text-gray-800">{b.room_name}</h3>
